...
import { cleanLocalStorageProjectPath, getSavedProjectPath, setLocalStorageProjectPath } from "./buildLink";
import { EditorLinkForm } from "./EditorLinkForm";
import { isExtension } from "./isExtension";
import { cleanLocalStorageLinkTemplate, getLinkTypeOrTemplate, setLocalStorageLinkTemplate } from "./linkTemplateUrl";
...
export function Options(props) {
  ...
  return (() => {
    ...
    _$insert(_el$, (() => {
      const _c$ = _$memo(() => props.adapterId === "svelte", true);
