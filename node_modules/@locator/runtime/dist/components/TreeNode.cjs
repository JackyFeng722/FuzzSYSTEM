...
function TreeNode(props) {
  ...
  function renderChildren() {
    return (0, _web.createComponent)(_solidJs.For, {
      ...
      children: child => (0, _web.createComponent)(TreeNode, {
        node: child,
  ...
  return (() => {
    ...
    _el$2.$$click = () => {
      if (props.node.source) {
        (0, _goTo.goToSource)(props.node.source, props.targets, options);
      }
    };
    ...
    (0, _web.insert)(_el$, (() => {
      ...
      return () => _c$() ? (0, _web.memo)((() => {
        const _c$3 = (0, _web.memo)(() => !!(props.node.type === "component" && props.node.source?.fileName), true);
