...
exports.ComponentOutline = ComponentOutline;
...
function ComponentOutline(props) {
  ...
  return (() => {
    ...
    (0, _web.insert)(_el$3, (0, _web.createComponent)(_solidJs.For, {
      ...
      children: label => {
        const link = label.link ? (0, _buildLink.buildLink)(label.link, props.targets, options) : null;
        ...
        return link ? (() => {
          ...
          (0, _web.style)(_el$4, labelStyles);
          (0, _web.setAttribute)(_el$4, "href", link);
          ...
          (0, _web.style)(_el$5, labelStyles);
          (0, _web.insert)(_el$5, () => label.label);
          return _el$5;
        })();
      }
    }));
    (0, _web.effect)(_p$ => {
      ...
      _p$._v$9 = (0, _web.style)(_el$2, _v$9, _p$._v$9);
