  ...
  return (() => {
    ...
    (0, _web.effect)(_p$ => {
      const _v$ = props.width + "px",
            _v$2 = props.width / 276 * 66 + "px";

      _v$ !== _p$._v$ && _el$2.style.setProperty("width", _p$._v$ = _v$);
