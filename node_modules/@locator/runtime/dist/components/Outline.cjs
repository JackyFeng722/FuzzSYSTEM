...
var _ComponentOutline = require("./ComponentOutline");
...
function Outline(props) {
  ...
  return [(() => {
    ...
    (0, _web.insert)(_el$2, () => props.element.thisElement.label, null);
    (0, _web.effect)(_p$ => {
      const _v$ = box().x + "px",
            _v$2 = box().y + "px",
            _v$3 = box().width + "px",
    ...
    return _el$;
  })(), (0, _web.createComponent)(_ComponentOutline.ComponentOutline, {
    get labels() {
