...
var computePosition, min, max, arrow, sides, allPlacements, oppositeSideMap, oppositeAlignmentMap, flip, offset, shift;
var init_floating_ui_core_esm = __esm({
  "node_modules/@floating-ui/core/dist/floating-ui.core.esm.js"() {
    ...
    allPlacements = sides.reduce((acc, side) => acc.concat(side, side + "-start", side + "-end"), []);
    oppositeSideMap = {
      left: "right",
      right: "left",
      bottom: "top",
...
//# sourceMappingURL=chunk-4AHZMZ2S.js.map
